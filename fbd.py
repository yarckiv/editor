        ...
        for b in blocks:
            ...
            if 'func' in b:
                ...
                for t_id in b['thread']:
                    ...
                    fncode += ' ' * (
                            indent + 8) + '__thread_{}.start()'.format(
                        t_id)
...
i = {'function': 'check_env',
     'input': [{'var': 'VAR1', 'description': 'var1 input'},
               {'var': 'VAR2', 'description': 'var2 input'}], 'body': [
        {'id': 0, 'function': 'PPPPP',
         'params': {'item_id': {'type': 'var_in', 'value': 'VAR1'}}},
        {'id': 1, 'function': 'value', 'params': {}},
        {'id': 2, 'function': 'state',
         'params': {'item_id': {'type': 'const', 'value': 'sensor:env/hum'}}},
        {'id': 3, 'function': 'GT',
        ...
        {'id': 4, 'function': 'LT',
         'params': {'IN': {'type': 'const', 'value': '30'},
                    'args': [{'type': 'block_out', 'value': 2}]}},
        {'id': 5, 'function': 'AND', 'params': {
            'args': [{'type': 'block_out', 'value': 3},
                     {'type': 'block_out', 'value': 4}]}}],
     'output': [{'var': 'OUT', 'value': 5, 'description': 'standard out'},
                {'var': 'TEMP1VAL', 'value': 0,
                 'description': 'value of temp1'}]}
print(gen_code_from_fbd(i))
