    ...
    var Step = function() {
      ...
      _createClass(Step, [{
        ...
        value: function setup() {
          ...
          } else if (!this.wizard.options.enableDisablingButtons && this.index > current) {
            this.enter('disabled');
          }
          if (this.wizard.options.enableDisablingButtons) {
            this.enter('done');
          }
          ...
          _jquery2.default.each(this.steps,
            ...
            function(i, step) {
              if (i > _this._current) {
                step.leave('error');
                step.leave('active');
                if (!_this.options.enableDisablingButtons) {
                  step.leave('done');
                }

                if (!_this.options.enableWhenVisited || !_this.options.enableDisablingButtons) {
                  step.enter('disabled');
                }
              }
            }
          ...
          var process = function process() {
            ...
            to.show(
              ...
              function() {
                ...
                if (!that.options.enableDisablingButtons) {
                  this.leave('disabled');
                }
